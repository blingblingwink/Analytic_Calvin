...
class YCSBSubClientQueryMessage : public YCSBClientQueryMessage {
public:
  uint8_t * piecesRemained;  // number of sub txns, this value works locally only, so no need to pass it through network
};
