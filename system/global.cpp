...
std::atomic<uint64_t> max_watermark;
#endif
...
UInt32 g_scheduler_thread_cnt = SCHEDULER_THREAD_CNT;
...
UInt32 g_short_req_per_query = REQ_PER_QUERY;
UInt32 g_long_req_per_query = LONG_REQ_PER_QUERY;
double g_long_txn_perc = LONG_TXN_PERC;
